...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2023 at 03:26 AM
...
--
-- Table structure for table `isf`
--

CREATE TABLE `isf` (
  `isfID` int(100) NOT NULL,
  `isfREMARKS` int(100) DEFAULT NULL,
  `isfCOMPETENCY` int(100) DEFAULT NULL
...
--
-- Table structure for table `siff`
--

CREATE TABLE `siff` (
  `siffID` int(100) NOT NULL,
  `siffSTUDENTID` int(100) DEFAULT NULL,
  `siffA1` int(100) DEFAULT NULL,
  `siffB1` int(100) DEFAULT NULL,
  `siffC1` int(100) DEFAULT NULL,
  `siffD1` int(100) DEFAULT NULL,
  `siffE1` int(100) DEFAULT NULL,
  `siffF1` int(100) DEFAULT NULL,
  `siffG1` int(100) DEFAULT NULL,
  `siffPROBS` varchar(1000) DEFAULT NULL,
  `siffCONS` varchar(1000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indexes for table `isf`
--
ALTER TABLE `isf`
  ADD PRIMARY KEY (`isfID`);
...
--
-- Indexes for table `siff`
--
ALTER TABLE `siff`
  ADD PRIMARY KEY (`siffID`);
...
--
-- AUTO_INCREMENT for table `isf`
--
ALTER TABLE `isf`
  MODIFY `isfID` int(100) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `siff`
--
ALTER TABLE `siff`
  MODIFY `siffID` int(100) NOT NULL AUTO_INCREMENT;
