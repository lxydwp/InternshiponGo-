...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2023 at 03:29 AM
...
(2, 'APPLICATION FOR INTERSHIP', NULL, NULL, NULL, NULL, 'fillafi.php'),
(3, 'Guidelines', NULL, NULL, NULL, NULL, 'Guidelines.php'),
(4, '12 INTERNSHIP AGREEMENT', NULL, NULL, NULL, NULL, 'INTERNSHIP AGREEMENT3.php'),
(5, 'PRACTICUM WEEKLY REPORT', NULL, NULL, NULL, NULL, '19 PRACTICUM WEEKLY REPORT.php'),
(6, '17 INTERNSHIP TIMEFRAME', NULL, NULL, NULL, NULL, '17 INTERNSHIP TIMEFRAME.php'),
(7, '21 Related Learning Experience Journal', NULL, NULL, NULL, NULL, '21 Related Learning Experience Journal.php'),
(8, 'Daily Journal', NULL, NULL, NULL, NULL, 'journalsave.php');
...
(31, '26', '8:00:21 am', '12:00:00 pm', '01:00:00 pm', '5:00:00 pm', NULL, NULL, '11-17-2022'),
(32, '26', '8:00:21 am', '12:00:00 pm', '01:00:00 pm', '5:00:00 pm', NULL, NULL, '11-18-2022'),
(33, '26', '8:00:21 am', '12:00:00 pm', '01:00:00 pm', '5:00:00 pm', NULL, NULL, '11-19-2022');
...
(26, 'Ricalyn', 'De Venecia', 'Perriras', 'Namolan Lingayen, Pangasinan', 'January 01, 1970', '', '19-LN-2080', '19-LN-2080', '1673419231.jpg', '', NULL, 'Vets Choice Radiology', 'Section 3', 'Bachelor of Science in Information and Technology', 'Pangasinan State University', NULL, NULL, '2023', '', '', 0, 0, 'active', NULL),
...
INSERT INTO `studentskills` (`studentskillsID`, `studentskillsTAGNAME`, `studentskillsSTUDENTID`, `studentskillsDES`) VALUES
(186, 'Java Developer', 26, 'cus'),
(187, 'Web Designing', 26, 'check'),
(188, 'PHP Deleveloper', 26, 'check'),
(189, 'students', 26, 'check');
...
--
ALTER TABLE `cform`
  MODIFY `CformID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `dtr`
--
ALTER TABLE `dtr`
  MODIFY `dtrID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `studentjournal`
  MODIFY `journalID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `studentskills`
--
ALTER TABLE `studentskills`
  MODIFY `studentskillsID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=190;
