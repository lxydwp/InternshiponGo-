               ...
               <div class="row align-items-center justify-content-between g-3 mb-3">
                  <div class="col col-auto">
                    <div class="search-box">
                      <form class="position-relative" data-bs-toggle="search" data-bs-display="static" method="post" action="query.php"><input class="form-control search-input search" type="search" placeholder="Search" aria-label="Search" name="Keyword" value="<?= $search; ?>" minlength="3"/>
...
<?php } } }else{ echo"<script type='text/javascript'>window.location.replace('agency.php');</script>"; }  ?>                      
