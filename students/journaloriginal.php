                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              ?>
                                <div class="mb-2"><label class="form-label text-900" for="">Number Of Hours*</label><input class="form-control" type="text" name="txthours" placeholder="" id="" value="<?php if ($x=='0'){echo '0';}else{ echo $echototal;}?>" readonly /></div>
                              </div>
                              <div class="col-sm-6">
                            ...
                            <div class="modal-footer">
                              ...
                              $dtr2=mysqli_query($con,"SELECT * from dtr where dtrSTUDENTID = '$rowstudent->StudentID' and dtrFULLDATE='$date42'")or die(mysqli_error($con));
                                ...
                                if ($y==0) {
                                ?>
                                <div class="alert alert-soft-danger alert-outline-danger" role="alert" style="width: 100%;">
                                <h5>Go to work and time in to open daily journal! <img src="../assets/img/46d4e75f02f52560c3e26a231c03c763.gif" loop="10" style="width: 45px;"></h5>
                               </div>
                               <?php   
                                }else if($y==1){
                              ?>
                               <div class="alert alert-soft-warning alert-outline-warning" role="alert" style="width: 100%;">
                                <h5>Horrey!! ,Youre too close, You can do it, Time out is comming! <img src="../assets/img/AS0005264_05.gif" loop="10" style="width: 45px;"></h5>
                               </div>
